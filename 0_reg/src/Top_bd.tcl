...
# module references:
# led_blinker_id, regs, dna_reader, user_efuse
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins regs_0/S_AXI]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins regs_0/S_AXI_ACLK] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins regs_0/S_AXI_ARESETN] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x20000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs regs_0/S_AXI/reg0] -force
